...
<div class="panel panel-default">
    				...
    				<!-- Form -->
    				<form role="search" id="formSortMembers" action="{{ route('members') }}" method="get">
    					...
    					<div class="form-group">
    					 ...
    					 <div class="form-group">
    					 	<button type="submit" id="searchBtn" value="search" class="btn btn-main btn-sm btn-block">
    					 		{{ trans('misc.find') }} <span class="glyphicon glyphicon-arrow-right"></span>
    					 		</button>

    					 		<div class="btn-block text-center margin-top-15">
    					 			<a href="{{route('members')}}">{{ trans('misc.reset') }}</a>
    					 		</div>

...
@section('meta')
    <link rel="canonical" href="{{ route('photo.samegroup',$vector->id) }}"/>
@endsection
@section('content')
        ...
        <div class="row mt-4">
            <div class="col-lg-2">
                <a href="{{ $vector->post_link }}">
                    <img class="w-100" srcset="{{ cdn($vector->thumbnail) }}"
            ...
            <div class="col-lg-9">
                <div class="mt-4 pb-4">
                    <p class="text-muted published mb-0">
                        <span> {!! trans('global.Stock_Id_Image',['id' => $vector->id])!!} </span>
                    </p>
                    <h4><a href="{{ $vector->post_link }}">{{ $vector->title }}</a></h4>
                </div>
            </div>
        </div>
        <div class="mt-5 mb-5">
                    ...
                    @foreach( $results as $r )
                        ...
                        <div class="item card-photo" data-w="{{($r->width_thumbnail)}}px"
                            ...
                            <div class="hover border-file h-100">
                                <a href="{{ $r->post_link }}">
                                    <img class="w-100 h-100" srcset="{{ cdn($r->thumbnail) }}"
                                         src="{{ cdn($r->thumbnail) }}"
                                        ...
                                        <div class="d-flex flex-row-reverse">
                                            <div class="icon_save">
                                                <span> <i data-id="{{$r->id}}"
                                                          ...
                                                          class="fal fa-heart @if($r->is_like) active @endif likeButton"></i> </span>
                                            ...
                                            {{--                                            <div onclick="goToCategory('{{$category->slug}}')" class="icon-similar">--}}

...
<div id="videos" class="col-md-3 video10" > <a href="{{ $video->post_link }}" class="more-famus">
	<video width="100%" class=" arabs-video" id="v{{$video->id}}" data-automation="VideoPlayer_video_video" loop="" muted="" playsinline="" poster="{{ $video->thumbnail_sm }}" style="transform: rotate(0deg); width: 100%;">

                    ...
                    <div class="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                الإحصائيات الشهرية لاضافة الفيكتور
                            </h3>
                        </div>
                            ...
                            <div class="kt-widget17__stats">
                                <div class="kt-widget17__items">
                                    ...
                                    <div class="kt-widget17__item">
                                        ...
                                        <a href="{{url('panel/admin/images/pending')}}">
                                            <span class="kt-widget17__subtitle">
                                                فيكتور غير نشطة
                                            </span>
                                        </a>
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fluid">
                        <div class="kt-widget20">
                            <div class="kt-widget20__content kt-portlet__space-x">
                                <span class="kt-widget20__number kt-font-brand">{{$payingCount}}+</span>
            ...
            <div class="col-xl-8 col-lg-12 order-lg-3 order-xl-1">
                ...
                <div class="kt-portlet kt-portlet--height-fluid">
                    <div class="kt-portlet__head">
                        ...
                        <form class="form-horizontal row" method="get" action="{{route('admin.vector.dashboard.index')}}">
                            ...
                            <div class="kt-portlet__body col-md-4">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3 col-sm-3">التجميعة</label>
                                    <div class="col-sm-9">
                                        <select class="form-control kt-select2" id="kt_select2_1" name="admin_collection_id">

                                           @if(isset($_GET['admin_collection_id']) && $_GET['admin_collection_id'] != null )
                                                <option value="{{$_GET['admin_collection_id']}}">{{$collection_name->title}}</option>
                                            ...
                                            @foreach($adminCollection as $adminCollectionItem)
                                                <option value="{{$adminCollectionItem->id}}">{{$adminCollectionItem->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-9 col-xl-9" style="margin-bottom: 10px;">
                              ...
                              <div class="dropdown dropdown-inline">
                                  <a href="{{route('admin.vector.dashboard.index')}}" class="btn btn-secondary btn-icon-sm">
                                    Back
                                        ...
                                        <div class="kt-widget5__item">
                                            <div class="kt-widget5__content">
                                                <div class="kt-widget5__pic">
                                                    <img class="kt-widget7__img" src="{{ url('uploads2/thumbnail/',$queryItem->thumbnail) }}" alt="">
                                                </div>
                                                <div class="kt-widget5__section">
                                                    ...
                                                    <div class="kt-widget5__info">
                                                        ...
                                                        <span class="kt-font-info">{{$queryItem->created_at}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="kt-widget5__content">
                                                <div class="kt-widget5__stats">
                                                    <span class="kt-widget5__number">{{$queryItem->data}}</span>
                                                    <span class="kt-widget5__sales">مبيعات</span>
                                                </div>
                    ...
                    <div class="kt-widget14">
                        <div class="kt-widget14__header">
                            ...
                            <span class="kt-widget14__desc">
                                توضيح الفيكتور الاكثر مبيعا بالنسبة لتصنيف
                            </span>
                        </div>
                        <div class="kt-widget14__content">
                            ...
                            <div class="kt-widget14__legends">
                                ...
                                @foreach($imagesCategoryPaying as $imagesCategoryPayingItem)
                                    @if($imagesCategoryPayingItem->data !=0)
                                        <div class="kt-widget14__legend">
                                            <span class="kt-widget14__bullet kt-bg-fill-info"></span>
                                            <span class="kt-widget14__stats">+{{ number_format((float)$imagesCategoryPayingItem->data/$totalImagesPaying*100, 2, '.', '') }}% {{$imagesCategoryPayingItem->name}}</span>
                                        </div>
                                    @endif
                                @endforeach
                            </div>
                        ...
                        <div class="kt-widget14__content">
                            ...
                            <div class="kt-widget14__legends">
                                ...
                                @foreach($imagesCategory as $imagesCategoryItem)
                                    @if($imagesCategoryItem->data !=0)
                                        <div class="kt-widget14__legend">
                                            <span class="kt-widget14__bullet kt-bg-fill-info"></span>
                                            <span class="kt-widget14__stats">+{{ number_format((float)$imagesCategoryItem->data/$totalImages*100, 2, '.', '') }}% {{$imagesCategoryItem->name}}</span>
                                        </div>
                                    @endif
                                @endforeach
                            </div>
      ...
      var KTDashboard = function () {
        ...
        return {
          ...
          //  datatableLatestOrders();
            ...
            // demo loading
            var loading = new KTDialog({'type': 'loader', 'placement': 'top center', 'message': locales.loading});
            loading.show();

                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__items">
                                    ...
                                    <div class="kt-widget__item ">
                                        ...
                                        <strong class="kt-badge--unified-danger kt-badge--sm kt-badge--rounded kt-badge--bolder">{{ App\Helper::formatNumber( \App\Models\VectorDownload::where('user_id',$data->id)->count() ) }}</strong>
                                    </div>
                                    ...
                                    <div class="kt-widget__item ">
                                        ...
                                        <strong class="kt-badge--unified-danger kt-badge--sm kt-badge--rounded kt-badge--bolder">{{ App\Helper::formatNumber( \App\Models\VectorLike::where('user_id',$data->id)->count() ) }}</strong>
                                    </div>
                                    ...
                                    <div class="kt-widget__item ">
                                        ...
                                        <strong class="kt-badge--unified-danger kt-badge--sm kt-badge--rounded kt-badge--bolder">{{ App\Helper::formatNumber( \App\Models\CommentVector::where('user_id',$data->id)->count() ) }}</strong>
                                    </div>

...
@section('content')
                            ...
                            <div class="kt-portlet__body">
                                <form id="fileupload" action="https://jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select style="width:100%" id="categories_id" name="categories_id[]" class="form-control" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select style="width:100%" id="collection_id" name="collection_id" class="form-control" >
                                    ...
                                    <div id="alert-html" style="display:none" class="alert alert-danger fade show" role="alert">
    ...
    <div class="modal" id="action-required-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="uploadOnlyUniqe()">{{ __("views.UploadOnlyUniqe") }}</button>
                    <button type="button" class="btn btn-danger" onclick="uploadAllWithRepeated()">{{ __("views.UploadAllWithRepeated") }}</button>
...
@push('scripts')
    ...
    <script>
      var fi = $('#fileupload'); //file input
        ...
        url: '{{route('admin.images.filemanger.store')}}',
        autoUpload: false,
        headers: {
        ...
        $.post(
          "{{route('admin.images.filemanger.check_unique')}}",
          {

                ...
                >
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            الإحصائيات الشهرية لاضافة الفيديو
                        </h3>
                    </div>
                </div>
                            ...
                            <div class="kt-widget17__items">
                                <div class="kt-widget17__item">
                                    ...
                                    <span class="kt-widget17__subtitle">
                                        <a
                                            href="{{route('admin.videos.videos.index')}}"
                                        >
                                            <span class="kt-widget17__subtitle">
                                                فيديو نشطة
                                            </span>
                                ...
                                <div class="kt-widget17__item">
                                    ...
                                    <a
                                        href="{{route('admin.videos.pending.index')}}"
                                    >
                                        <span class="kt-widget17__subtitle">
                                            فيديو غير نشطة
                                        </span>
            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__head">
                    <form
                        ...
                        method="get"
                        action="{{route('admin.videos.dashboard.index')}}"
                    >
                        <div class="kt-portlet__body col-md-4">
                            <div class="form-group row">
                                <label class="pr-0 pl-0 col-form-label col-lg-3 col-sm-12"
                                    >التاريخ من</label
                                >
                                <div class="col-sm-9">
                                    <input @if(isset($_GET['from_date']))
                                    value="{{$_GET['from_date']}}" @endif
                        ...
                        <div class="kt-portlet__body col-md-4">
                            <div class="form-group row">
                                <label class="pr-0 pl-0 col-form-label col-lg-3 col-sm-3"
                                    >التاريخ الي</label
                                >
                                <div class="col-sm-9">
                                    <input @if(isset($_GET['to_date']))
                                    value="{{$_GET['to_date']}}" @endif
                        ...
                        <div class="dropdown dropdown-inline">
                            ...
                            >
                                <i class="flaticon2-search"></i> فلترة
                            </button>
                        </div>
                        <div class="dropdown dropdown-inline">
                            <a
                                href="{{route('admin.videos.dashboard.index')}}"
                ...
                <div class="kt-widget14">
                    <div class="kt-widget14__header">
                        <h3 class="kt-widget14__title">
                            اكثر الفيديوهات مبيعا
                        </h3>
                        <span class="kt-widget14__desc">
                            توضيح الفيديو الاكثر مبيعا بالنسبة لتصنيف
                        </span>
                    </div>
                    <div class="kt-widget14__content">
                        ...
                        <div class="kt-widget14__legends">
                            @foreach($videosCategoryPaying as
                            $r)
                            @if($r->videos_count !=0)
                            <div class="kt-widget14__legend">
                                <span
                                    class="kt-widget14__bullet kt-bg-fill-info"
                                ></span>
                                <span class="kt-widget14__stats"
                                    >+{{
                                    number_format((float)$r->videos_count/$totalImagesPaying*100,
                                    2, '.', '') }}%
                                    {{$r->name}}</span
                                >
                            </div>
                    ...
                    <div class="kt-widget14__content">
                        ...
                        <div class="kt-widget14__legends">
                            ...
                            <div class="kt-widget14__legend">
                                ...
                                <span class="kt-widget14__stats"
                                    >+{{
                                    number_format((float)$r->videos_count/$totalImages*100,
                                    2, '.', '') }}%
                                    {{$r->name}}</span
                                >
                            </div>
        ...
        var profitShare = function () {
          ...
          var config = {
            ...
            data: {
              datasets: [{
                data: [
                    @foreach($videosCategoryPaying as $r)
                    @if($r->videos_count !=0)
                    {{$r->videos_count}},
                    @endif
                    @endforeach

                        ...
                        <div class="kt-portlet">
                            ...
                            <div class="kt-portlet__body">
                                <form id="fileupload" action="https://jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
                                    ...
                                    {{-- <div class="form-group row border border-secondarys">
                                        <label class="col-1 col-form-label">{{ trans('misc.original_type') }} </label>
                                        <div class="col-11">
                                            <div class="kt-radio-inline">
                                                <label class="kt-radio kt-radio--success">
                                                    <input type="radio" value="normal" checked name="original_type"> normal
                                                    <span></span>
                                                </label>
                                                <label class="kt-radio kt-radio--success">
                                                    <input type="radio" value="raw" name="original_type"> raw
                                                    <span></span>
                                                </label>
                                    ...
                                    <div class="row fileupload-buttonbar">
                                        <div class="col-lg-10">
                                            ...
                                            <span class="btn btn-success fileinput-button">
                                                ...
                                                <span>استعراض...</span>
                                                <input type="file" name="file" accept=".mp4 , .mov" multiple/>
                                            </span>
...
@push('scripts')
    ...
    <script>
        var fi = $('#fileupload'); //file input
            ...
            timeout: 300000000,
            url: '{{ env('MEDIA_URL').'/api/admin/videos' }}',
            autoUpload: false,
            headers: {
...
{{--    <script>--}}
{{--      $('#fileupload22').fileupload({--}}
{{--        method: 'POST',--}}
{{--        // Uncomment the following to send cross-domain cookies:--}}
{{--        //    xhrFields: {withCredentials: true},--}}
{{--          url: '{{ 'https://mediaprocessing.test/api/admin/videos' }}',--}}
{{--          autoUpload: false,--}}
{{--          headers: {--}}
{{--              'Authorization' : 'Bearer {{ $accessToken }}',--}}
{{--              'Language' : '{{config('app.locale')}}',--}}
...
{{--        allowedFileExtensions: [ 'mp4', 'mpeg', 'flv', 'mkv'],--}}
{{--        acceptFileTypes: /(\.|\/)(mov|Mp4|mpeg|flv|mkv)$/i,--}}
{{--        minFileSize : 4194304 ,// 4 MB--}}
{{--        maxFileSize:  3999268864, // 3814 MB--}}
{{--        success: function (data) {--}}

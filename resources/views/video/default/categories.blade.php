    ...
    <div class="category-header jumbo-banner" data-overlay="6" style="background-image: url(/img/banner-footer-bg.webp);">
        <div class="container-fluid">
            <div class="col-lg-12 col-md-12">
                ...
                <p class="subtitle-site"><strong>{{trans('misc.browse_videos_by_category')}}</strong></p>
            </div>
        </div>
    </div>
                        ...
                        @if($categoryCity->cities_and_landmarks==='on')
                            <div class="col-12 col-sm-6 col-md-3 col-lg-3 mb-2 pd-l-r--3">
                                <div class="cities-category" style="background-image: url('{{ url($categoryCity->thumbnail)}}')">
                                    <a href="{{ route('video.category.show',$categoryCity->slug) }}">
                                        <div class="hover">
                                            <div class="hover-overlay"></div>
                                        </div>
                                    </a>
  ...
  <div class="container-fluid">
    <div class="row justify-content-between">
      <div class="col-12 col-sm-11 col-md-11 col-lg-11">
        ...
        <p class="color-secondary">{{ trans('global.Green_background_easier_for_you') }}</p>
      </div>
      <div class="d-none d-sm-block col-sm-1 col-md-1 col-lg-1 text-right">
        <div class="mt-5 pt-3 mb-0"> <a href="{{ route('video.category.show','chroma') }}"> <span class="d-block color-primary"><i class="fal fa-ellipsis-h-alt"></i></span> <span class="d-block color-secondary">{{ trans('global.more') }}</span> </a> </div>
      </div>
    </div>
    <div class="center-row-section row">
  <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2 pd-l-r--3">
		<div class="chroma-category" style="background-image: url('/img/chroma.webp')">

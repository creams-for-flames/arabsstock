...
<div class="container collections">
    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{route('me.collections.videos')}}"><i class="fal fa-video"></i> {{ trans('misc.videos') }} ({{number_format($data->total())}})</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{route('me.collections.vectors')}}"><i class="fal fal fa-tilde fa-lg"></i> {{ trans('misc.vectors') }}</a>
        </li>
    </ul>

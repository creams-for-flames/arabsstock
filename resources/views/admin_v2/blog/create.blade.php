                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">{{ trans('misc.add_new') }}</h3>
                        </div>
                    </div>
                    <form class="kt-form kt-form--label-left"  method="post" action="{{$store_url}}" enctype="multipart/form-data">
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('title_en') }}" name="title_en" class="form-control" placeholder="{{ trans('admin.title_en') }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">{{ trans('admin.title_ar') }}</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('title_ar') }}" name="title_ar" class="form-control" placeholder="{{ trans('admin.title_ar') }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="content_en"rows="5" cols="40" id="content_en" class="editable" placeholder="{{ trans('admin.content_en') }}">{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">{{ trans('admin.content_ar') }}</label>
                                        <div class="col-sm-10">
                                            <textarea name="content_ar"rows="5" cols="40" id="content_ar" class="editable" placeholder="{{ trans('admin.content_ar') }}">{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body kt-portlet__body--fit">
            <!--begin: Datatable -->
            <div class="kt-datatable" id="kt_admin_collection_list_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!--end::Portlet-->
...
var KTUserListDatatable = function() {
  ...
  var init = function() {
    ...
    datatable = $('#kt_admin_collection_list_datatable').KTDatatable({
...
saveState: {
      ...
      columns: [{
        ...
        field: 'count',
        title: '{{__('admin.images_download')}}',
      }, {
        field: 'status',
        ...
        template: function(row) {
          ...
          var dash_link = '{{$dash_link}}'.replace('/0', '/' + row.id);
              ...
              <div class="dropdown">\
                ...
                <div class="dropdown-menu dropdown-menu-right">\
                  <ul class="kt-nav">\
                    ...
                    @if(!isset($is_videos_site) || !isset($is_vectors_site))
                    <li class="kt-nav__item">\
                      <a href="'+dash_link+'" class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-chart"></i>\
                        <span class="kt-nav__link-text">{{__('views.PerformanceReports')}}</span>\
                      </a>\
                    </li>\
                    @endif
                    <li class="kt-nav__item">\

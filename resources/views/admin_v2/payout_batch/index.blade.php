...
saveState: {
      ...
      },
      {
        ...
        title: 'sender_batch_id',
        sortable: false,
      },
      {
        field: 'payout_batch_id',
        title: 'payout_batch_id',
        sortable: false,
      },
       {
        field: 'date',
      ...
      },
      {
        ...
        title: 'عدد العمليات',
        template: function(row, index, datatable) {
          return row.payout_item.length;
        },
      },
      {
        field: 'payout_batch_status',
        title: 'حالة عملية التحويل',
        width: 100,
        // callback function support for column rendering
        template: function(row) {
          var payout_batch_status = {
            'WAITING':{
          ...
          return '<span class="btn btn-bold btn-sm btn-font-sm ' + _.get(payout_batch_status, [row.payout_batch_status, 'class'], '') + '">' + _.get(payout_batch_status, [row.payout_batch_status, 'title'], '') + '</span>';
        }
      },
      {
        field: "Actions",

    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <!--begin: Datatable -->
                <div class="kt-datatable" id="kt_submission_list_datatable"></div>
                <!--end: Datatable -->
            </div>
        </div>
        <!--end::Portlet-->
    ...
    <script>
        ...
        var KTUserListDatatable = function () {
            ...
            var init = function () {
                ...
                datatable = $('#kt_submission_list_datatable').KTDatatable({
                    ...
                    , {
                        ...
                        template: function (row) {
                            var review_url = '';
                            if (row.count > 1)
                                review_url = '{{ route('admin.contributors.submissions.index') }}?contributor=' + row.contributor_id + '&date=' + moment(row.created_at).format("YYYY/MM/DD")
                            else
                                review_url = '{{$review_url}}'.replace('/0/', '/' + row.id + '/')
                            return '\
              <div class="dropdown">\
                ...
                <div class="dropdown-menu dropdown-menu-right">\
                  <ul class="kt-nav">\
                    <li class="kt-nav__item">\
                      <a href="' + review_url + '" class="kt-nav__link">\
            ...
            var selection = function () {
                ...
                datatable.on('kt-datatable--on-check kt-datatable--on-uncheck kt-datatable--on-layout-updated', function (e) {
                    if ($('.kt-datatable__pager-info input[type="number"]').length == 0) {
                        $('.kt-datatable__pager-info').prepend(`<div class="form-group text-center mr-2"><label> رقم الصفحة </label><input type="number" min="1" class="form-control text-center" style="width: 100px;" value="` + datatable.getCurrentPage() + `"></div>`);
                    }
                    $(document).on('change', '.kt-datatable__pager-info input[type="number"]', function (e) {
                        var page = $(this).val()

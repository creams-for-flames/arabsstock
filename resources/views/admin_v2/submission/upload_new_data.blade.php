            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        يجب رفع ملف .zip يحتوي على ملف data.xlsx حسب أعمدة بأسماء معتمدة
                        <br>
                        أسماء الأعمدة المطلوبة في ملف excel
                        <br>
                        fname: اسم ملف الصورة المرفوع
                        <br>
                        title_en
                        <br>
                        title_ar
                        ...
                        tags_ar
                        <br>
                        releases: القيم المسموحة (model,property)
                        <br>
                        license_path : اختياري(يحتوي مسار مجموعة ملفات الرخص)
                        <br>
                        license_files: اختياري
                    </div>
                </div>
            </div>
        </div>

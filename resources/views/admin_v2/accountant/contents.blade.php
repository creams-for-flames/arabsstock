...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet">
            ...
            <form class="kt-form " action="{{route('admin.accountant.export_contents')}}" method="get">
                <input type="hidden" name="type" value="{{ \App\Models\Image::class }}">
...
الفيديوهات
            ...
            <form class="kt-form " action="{{route('admin.accountant.export_contents')}}" method="get">
                <input type="hidden" name="type" value="{{ \App\Models\Video::class }}">
                <div class="kt-portlet__body">
                    <div class="row align-items-center">
                        <div class="col-md-8 order-md-1">
                            <div class="row align-items-center">
...
الفيكتور
            ...
            <form class="kt-form " action="{{route('admin.accountant.export_contents')}}" method="get">
                <input type="hidden" name="type" value="{{ \App\Models\Vector::class }}">
                <div class="kt-portlet__body">
                    <div class="row align-items-center">
                        <div class="col-md-8 order-md-1">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                    <div class="form-group">
                                        ...
                                        >
                                            <option value=""></option>
                                            @foreach(\App\Models\User::where('role','admin_vector')->get() as $r)
                                                <option value="{{ $r->id }}">{{ $r->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>

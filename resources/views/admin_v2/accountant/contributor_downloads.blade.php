...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet">
            ...
            <form class="kt-form " action="{{route('admin.user_plans.items.export_contributor_downloads')}}" method="get">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                    <div class="form-group">
                                        ...
                                        <select name="purchaseable_type" class="form-control"
                                        >
                                            <option value="0">الكل</option>
                                            <option value="{{ \App\Models\Image::class }}">صور</option>
                                            <option value="{{ \App\Models\Video::class }}">فيديو</option>
                                            <option value="{{ \App\Models\Vector::class }}">فيكتور</option>
                                        </select>
                                    </div>
                                </div>
                            </div>

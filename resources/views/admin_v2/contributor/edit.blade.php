                                      ...
                                      <div class="kt-section kt-section--first">
                                          <div class="kt-section__body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" value="{{ $data->name }}" disabled="disabled" name="welcome_text" class="form-control" placeholder="{{ trans('auth.username') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-12">
                                                      <input type="text" value="{{ $data->mobile }}" name="mobile" class="form-control" placeholder="{{ __('Mobile') }}" style="direction: ltr;text-align: right" >
                                                  </div>
                                              </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">{{ trans('misc.profit_ratio') }}</label>
                                                <div class="col-sm-12">
                                                    <input type="text" value="{{ $data->profit_ratio }}" name="profit_ratio" class="form-control" placeholder="{{ trans('misc.profit_ratio') }}">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="show_land_images" class="control-label">{{ trans('misc.show_land_images') }}</label>
                                                <div class="col-sm-12">
                                                    <input type="checkbox" @if($data->show_land_images) checked @endif name="show_land_images" class="" placeholder="{{ trans('misc.show_land_images') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="show_land_vectors" class="control-label">{{ trans('misc.show_land_vectors') }}</label>
                                                <div class="col-sm-12">
                                                    <input type="checkbox" @if($data->show_land_vectors) checked @endif name="show_land_vectors" class="" placeholder="{{ trans('misc.show_land_vectors') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="show_land_videos" class="control-label">{{ trans('misc.show_land_videos') }}</label>
                                                <div class="col-sm-12">
                                                    <input type="checkbox" @if($data->show_land_videos) checked @endif name="show_land_videos" class="" placeholder="{{ trans('misc.show_land_videos') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="is_active_upload_raw" class="control-label">{{ trans('misc.is_active_upload_raw') }}</label>
                                                <div class="col-sm-12">
                                                    <input type="checkbox" @if($data->is_active_upload_raw) checked @endif name="is_active_upload_raw" class="" placeholder="{{ trans('misc.is_active_upload_raw') }}">
                                                </div>
                                            </div>

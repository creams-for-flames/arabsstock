...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body kt-portlet__body--fit">
            <!--begin: Datatable -->
            <div class="kt-datatable" id="kt_invoice_list_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!--end::Portlet-->
...
var KTUserListDatatable = function() {
  ...
  var init = function() {
    ...
    datatable = $('#kt_invoice_list_datatable').KTDatatable({
...
saveState: {
      ...
      columns: [{
        ...
        field: 'total',
        title: '{{__('global.invoices.fields.price')}}',
      }, {
        field: 'created_at',
        title: '{{__('global.invoices.fields.date-of-payment')}}',
        template: function(row, index, datatable) {
        ...
        template: function(row) {
          var statuses = {
            0: {
              'title': '{{__('views.NotCompleted')}}',
              'class': ' btn-label-danger'
            },
            1: {
              'title': '{{__('views.Completed')}}',
              'class': ' btn-label-success'
            },
          };
          return '<span class="btn btn-bold btn-sm btn-font-sm ' + statuses[row.is_paid].class + '">' + statuses[row.is_paid].title + '</span>';
        }
      }, {
        field: 'unique_code',
        title: '{{__('global.invoices.fields.unique-code')}}',
        sortable: false,
      }, {
        field: "Actions",
        width: 80,

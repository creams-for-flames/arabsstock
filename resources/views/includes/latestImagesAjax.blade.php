...
<div class="item card-photo"  data-w="{{($imageItem->width_thumbnail)}}px" data-h="{{($imageItem->height_thumbnail)}}px">
    <div class="hover border-file h-100">
        <a href="{{ $imageItem->post_link }}">
        <img class="w-100 h-100" srcset="{{ cdn($imageItem->thumbnail) }}" src="{{ url($imageItem->thumbnail) }}" alt="{{$imageItem->title}}">
        ...
        <div class="card-photo-content">
            ...
            <div class="icon">
                <div class="d-flex flex-row-reverse">
                    ...
                    <div class="icon_save" onclick="showModal('{{$imageItem->id}}','{{class_basename($imageItem)}}','{{ cdn($imageItem->thumbnail) }}','{{$imageItem->title}}')">

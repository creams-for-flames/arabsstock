                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="padding: 25px 0; text-align: center;">
                            <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="{{route('landPage')}}" target="_blank">
                                {{$settings->title}}
                            </a>
                        </td>
                    </tr>
                   ...
                   <!-- Intro -->
                     <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                               <a href="{{route('account.verify',$confirmation_code)}}">Click here</a> to confirm your email

                                               {{route('account.verify',$confirmation_code)}}
                                            </p>

...
@endsection
@push('header')
    <link href="{{ asset('css/tailwindcss@1.9.6_dist_tailwind.min.css') }}" rel="stylesheet">
    <script src="{{ asset('js/vue@2.6.10_dist_vue.min.js') }}"></script>

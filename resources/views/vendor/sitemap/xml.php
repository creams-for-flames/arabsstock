...
if (! empty($item['images'])) {
    ...
    foreach ($item['images'] as $image) {
        ...
        if (isset($image['description'])) {
            echo "\t\t\t".'<image:description><![CDATA['.$image['description'].']]></image:description>'."\n";
        }
        if (isset($image['view_count'])) {
            echo "\t\t\t".'<image:view_count><![CDATA['.$image['view_count'].']]></image:view_count>'."\n";
        }
        if (isset($image['publication_date'])) {
            echo "\t\t\t".'<image:publication_date><![CDATA['.$image['publication_date'].']]></image:publication_date>'."\n";
        }
        ...
        echo "\t\t".'</image:image>'."\n";
        if (isset($image['link_ar'])) {



            echo "\t\t\t" . '<xhtml:link rel="alternate" hreflang="ar" href="' .$image['link_ar'] . '"/>' . "\n";

        }

        if (isset($image['link_en'])) {



            echo "\t\t\t" . '<xhtml:link rel="alternate" hreflang="en" href="' .$image['link_en'] . '"/>' . "\n";

...
return array(
	...
	*/
    ...
    'access_denied_you_have_content'=>'Access denied you have content files',
    ...
    'roles' => [
        'normal' => 'Normal',
        'admin' => 'Image Admin',
        'admin_video' => 'Video Admin',
        'admin_vector' => 'Vector Admin',
        'admin_image_editor' => 'Image Editor',
        'admin_video_editor' => 'Video Editor',
        'admin_vector_editor' => 'Vecotr Editor',
        'admin_super' => 'Cast Admin',
	],
    ...
    "video"=>"video",
    "vector"=>"vector",
    "weekly_letter_sent"=>"Weekly letter is being sent successfully",
	"sent"=>"sent",
	"mail_in_processing"=>"The mail is in process, the number of ready files is :files_generated, the remaining :files_pending",
	"categories_count"=> "catagories count",
    "files_count"=>"files count",
	'mail_processing'=>"mail in processing",
	'refresh'=>"refresh",
	'permanently'=>"permanently rejected",
    'temporarily'=>"temporarily rejected",
    "RejectionReason"=>"Rejection Reasons ",
	"is_being_sent"=>"is being sent",
	"send"=>"send",
	"warehouse_check"=>"warehouse check",
    'update_last'=>"The file was previously updated",
    "check_images_removebg_admin"=>"Check images removebg admin",
    'contract'=>"contract",

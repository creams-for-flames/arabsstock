...
class SubscriptionsExport implements WithMapping, WithHeadings, FromCollection, ShouldAutoSize
{
    ...
    public function map($subscription): array
    {
        return [
            ...
            $subscription->plan ? $subscription->plan->downloads_count : '-',
            $subscription->download_remaining ?: 0,
            $subscription->amount,
    ...
    public function headings(): array
    {
        ...
        array_push($heading, __('misc.downloads'));
        array_push($heading, __('global.user-plans.fields.download-remaining'));

...
class VectorExport implements WithMapping,WithHeadings,FromCollection
{
    protected $Objects;
    ...
    {
        $arr['id'] = $object->id;
        $arr['up_type'] = ($object->contributor_vector_id == 0)?'ArStock':'Contributor';
        $arr['Contributor'] = ($object->contributor_vector_id != 0 &&$object->user_id != 1 && $object->user)?$object->user->name:'-';

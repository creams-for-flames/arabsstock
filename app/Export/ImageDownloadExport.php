...
class ImageDownloadExport implements WithMapping, WithHeadings, FromCollection, ShouldAutoSize
{
    protected $Objects;
    ...
    {
        $purchase = Purchase::where('purchaseable_type', Image::class)->where('purchaseable_id', $object->image_id)->where('user_id', $object->user_id)->first();
        return [
            $object->id,
            $object->image_id,

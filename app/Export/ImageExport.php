...
class ImageExport implements WithMapping,WithHeadings,FromCollection
{
    protected $Objects;
    ...
    {
        $arr['id'] = $object->id;
        $arr['up_type'] = ($object->user_id == 1)?'ArStock':'Contributor';
        $arr['Contributor'] = ($object->user_id != 1 && $object->user)?$object->user->name:'-';

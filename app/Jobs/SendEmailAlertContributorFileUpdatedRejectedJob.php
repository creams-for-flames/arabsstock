...
use App\Mail\SendEmailAlertContributorFileUpdatedRejected;
use App\Models\BouncedEmail;
use App\Models\{ContributorImage,ContributorVector,ContributorVideo};
...
class SendEmailAlertContributorFileUpdatedRejectedJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (BouncedEmail::where('email', $mail)->count())
            return;
        $email = new SendEmailAlertContributorFileUpdatedRejected($data);

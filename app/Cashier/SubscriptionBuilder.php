...
class SubscriptionBuilder
{
     ...
     *
     * @var \App\Cashier\Billable|\Illuminate\Database\Eloquent\Model
     */
    protected $owner;
     ...
     * @return \App\Cashier\Subscription
     *
    ...
    protected function createSubscription(StripeSubscription $stripeSubscription)
    {
        ...
        /** @var \App\Cashier\Subscription $subscription */

...
use App\Cashier\Contracts\InvoiceRenderer;
use App\Cashier\Exceptions\InvalidInvoice;
...
class Invoice implements Arrayable, Jsonable, JsonSerializable
{
     ...
     *
     * @var \App\Cashier\InvoiceLineItem[]
     */
    protected $items;
     ...
     * @return void
     *
     * @throws \App\Cashier\Exceptions\InvalidInvoice
     */
     ...
     *
     * @param  \App\Cashier\Discount  $discount
     * @return string|null
     */
     ...
     *
     * @return \App\Cashier\InvoiceLineItem[]
     */

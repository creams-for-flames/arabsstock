...
class CategoryContributorVideoController extends Controller
{
    ...
    public function index()
    {
        ...
        $destroy_url = route('admin.video.categories_contributores.destroy', 0);
        $is_videos_site = true;
        ...
        $html_new_path = route('admin.video.categories_contributores.create');
        $subheader_actions = [
            'delete' => [
                'type' => 'button',
                'text' => __('views.Delete All'),
                'url' => route('admin.video.categories_contributores.destroy', 0),
                'method' => 'delete',
                'confirm' => __(
    ...
    {
        $index_url = route('admin.video.categories_contributores.index');
        $store_url = route('admin.video.categories_contributores.store');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.video.categories_contributores.index');
    }
    ...
    public function edit($id)
    {
        ...
        $index_url = route('admin.video.categories_contributores.index');
        $update_url = route('admin.video.categories_contributores.update', $id);

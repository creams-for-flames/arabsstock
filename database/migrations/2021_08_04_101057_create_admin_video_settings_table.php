...
class CreateAdminVideoSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('admin_video_settings', function (Blueprint $table) {
            $table->engine = 'MyISAM';
            $table->increments('id');
            ...
            $table->decimal('sd_price')->default(0.00);
            $table->decimal('hd_price')->default(0.00);
            $table->decimal('fhd_price')->default(0.00);
            $table->decimal('four_k_price')->default(0.00);
    ...
    {
        Schema::dropIfExists('admin_video_settings');
    }
}

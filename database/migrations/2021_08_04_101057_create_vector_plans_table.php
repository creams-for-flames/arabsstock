...
class CreateVectorPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vector_plans', function (Blueprint $table) {
            $table->engine = 'MyISAM';
            $table->increments('id');
            $table->enum('type_content', ['images', 'videos', 'vectors'])->default('vectors');
    ...
    {
        Schema::dropIfExists('vector_plans');
    }
}

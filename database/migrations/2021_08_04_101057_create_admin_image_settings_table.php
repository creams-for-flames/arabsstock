...
class CreateAdminImageSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('admin_image_settings', function (Blueprint $table) {
            $table->engine = 'MyISAM';
            $table->increments('id');
            ...
            $table->decimal('minimum_payout', 10)->nullable();
    ...
    {
        Schema::dropIfExists('admin_image_settings');
    }
}

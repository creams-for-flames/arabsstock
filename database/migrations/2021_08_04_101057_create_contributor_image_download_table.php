...
class CreateContributorImageDownloadTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contributor_image_download', function (Blueprint $table) {
            $table->engine = 'MyISAM';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('contributor_image_download');
    }
}

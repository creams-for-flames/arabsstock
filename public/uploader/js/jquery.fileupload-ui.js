        ...
        if (data.context) {
          data.context.each(function(index) {
            if (data.errorThrown !== 'abort') {
              ...
              var error_file = data._response.jqXHR.responseJSON && data._response.jqXHR.responseJSON.errors ? data._response.jqXHR.responseJSON.errors.file : data.i18n('An error occurred, please contact your system administrator');
              var error_msg = file.error || error_file || data.errorThrown || data.i18n('unknownError');

...
(/** @lends <global> */function( $ ) {
		...
		else if ( typeof mSource === 'function' )
		{
			return function (data, val, meta) {
				mSource( data, 'set', val, meta );
			      ...
			      mSource.indexOf('[') !== -1 || mSource.indexOf('(') !== -1) )
		{
			/* ImageLike the get, we need to get data from a nested object */
	 ...
	 * convenience when setting a new URL. ImageLike `ajax.reload()` it will
	...
	DataTable.defaults.column = {
		 ...
		 * `data` which is read / write (then as such more complex). ImageLike `data`

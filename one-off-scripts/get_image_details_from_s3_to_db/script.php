...
[4796, '-15873087174acrd.jpg'],
[4797, '-15873087359nypo.jpg'],
[4798, '-1587308746veimm.jpg'],
])->chunk(100);
...
foreach ($images_chunks as $images_chunk) {
    ...
    foreach ($images_chunk as $image) {
        ...
        $raw_query .= "UPDATE `images` SET `width_preview` = '$width', `height_preview` = '$height' WHERE `images`.`id` = {$image[0]};";
    }
    sleep(3);
